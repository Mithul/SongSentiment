...
class ClassificationsControllerTest < ActionController::TestCase
  ...
  test "should create classification" do
    assert_difference('Classification.count') do
      post :create, classification: { artist: @classification.artist, genre: @classification.genre, mood: @classification.mood, rating: @classification.rating, song_name: @classification.song_name, user_id: @classification.user_id }
    end
  ...
  test "should update classification" do
    patch :update, id: @classification, classification: { artist: @classification.artist, genre: @classification.genre, mood: @classification.mood, rating: @classification.rating, song_name: @classification.song_name, user_id: @classification.user_id }
    assert_redirected_to classification_path(assigns(:classification))
  end
